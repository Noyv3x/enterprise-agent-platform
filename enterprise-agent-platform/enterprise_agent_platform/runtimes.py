...
class PlatformRuntimeManager:
    ...
    def _firecrawl_command(self) -> tuple[list[str], Path | None, str]:
        ...
        self._ensure_firecrawl_compose_override(repo)
        return (
            [
                "docker",
                "compose",
    ...
    @staticmethod
    def _ensure_firecrawl_compose_override(repo: Path) -> None:
        override = repo / FIRECRAWL_COMPOSE_OVERRIDE
        text = "\n".join(
            [
