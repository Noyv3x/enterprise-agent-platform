...
export const chatMessages = defineMessages({
  ...
  "chat.work.detail.tool": { "zh-CN": "工具", en: "Tool", "zh-TW": "工具" },
  "chat.work.detail.status": { "zh-CN": "状态", en: "Status", "zh-TW": "狀態" },
  "chat.work.detail.time": { "zh-CN": "时间", en: "Time", "zh-TW": "時間" },
  "chat.work.detail.parameters": { "zh-CN": "参数", en: "Parameters", "zh-TW": "參數" },
