...
export const chatMessages = defineMessages({
  ...
  "chat.withdraw.confirmDescription": {
    "zh-CN": "消息会从频道中隐藏；已开始的 Agent 任务不会取消。",
    en: "The message will be hidden from the channel. Any Agent task already started will continue.",
    "zh-TW": "訊息會從頻道中隱藏；已開始的 Agent 任務不會取消。",
  },
  ...
  "chat.withdraw.success": {
    "zh-CN": "消息已从频道中撤回",
    en: "The message was withdrawn from the channel",
    "zh-TW": "訊息已從頻道中收回",
  },
