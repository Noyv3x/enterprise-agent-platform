...
export const chatMessages = defineMessages({
  ...
  "nav.channel.manage": { "zh-CN": "管理频道「{name}」", en: "Manage channel “{name}”", "zh-TW": "管理頻道「{name}」" },
  "nav.channel.delete": { "zh-CN": "删除频道", en: "Delete channel", "zh-TW": "刪除頻道" },
  "nav.channel.deleteTitle": { "zh-CN": "删除频道「{name}」？", en: "Delete channel “{name}”?", "zh-TW": "刪除頻道「{name}」？" },
  "nav.channel.deleteDescription": {
    "zh-CN": "删除后，所有成员将无法再进入此频道，排队中与执行中的任务将停止。此操作无法恢复。",
    en: "Members will lose access to this channel, and queued and running tasks will stop. This cannot be restored.",
    "zh-TW": "刪除後，所有成員將無法再進入此頻道，排隊中與執行中的任務將停止。此操作無法還原。",
  },
  "nav.channel.deleteRetention": {
    "zh-CN": "频道将归档，而不是清除记录。消息、文件、会话与审计记录会保留；频道名称仍被保留，无法重新使用。",
    en: "The channel is archived, not purged. Messages, files, sessions, and audit records are retained. Its name remains reserved and cannot be reused.",
    "zh-TW": "頻道將封存，而不是清除紀錄。訊息、檔案、工作階段與稽核紀錄會保留；頻道名稱仍被保留，無法重新使用。",
  },
  "nav.channel.deleting": { "zh-CN": "正在删除…", en: "Deleting…", "zh-TW": "正在刪除…" },
  "nav.channel.deleteSuccess": { "zh-CN": "频道已删除，记录已归档保留。", en: "Channel deleted. Records are retained in the archive.", "zh-TW": "頻道已刪除，紀錄已封存保留。" },
  "nav.channel.deleteFailed": { "zh-CN": "尚未确认频道删除完成。", en: "Channel deletion has not been confirmed.", "zh-TW": "尚未確認頻道刪除完成。" },
  "nav.channel.deleteRetry": { "zh-CN": "重试删除", en: "Retry deletion", "zh-TW": "重試刪除" },
  "nav.channel.deleteRetryNamed": { "zh-CN": "重试删除「{name}」", en: "Retry deleting “{name}”", "zh-TW": "重試刪除「{name}」" },
  "nav.channel.deleteRetryHint": {
    "zh-CN": "「{name}」可能已归档并从列表移除，但运行环境清理尚未完成。重试会继续清理同一频道，不会恢复频道或删除保留记录。",
    en: "“{name}” may already be archived and removed from the list while runtime cleanup is unfinished. Retry completes cleanup for this same channel; it does not restore the channel or erase retained records.",
    "zh-TW": "「{name}」可能已封存並從清單移除，但執行環境清理尚未完成。重試會繼續清理同一頻道，不會還原頻道或刪除保留紀錄。",
  },
  ...
  "chat.preview.kind.xlsx": { "zh-CN": "Excel 工作簿", en: "Excel workbook", "zh-TW": "Excel 活頁簿" },
  "chat.preview.kind.docx": { "zh-CN": "Word 文档", en: "Word document", "zh-TW": "Word 文件" },
  "chat.preview.kind.pptx": { "zh-CN": "演示文稿", en: "Presentation", "zh-TW": "簡報" },
  "chat.preview.kind.pdf": { "zh-CN": "PDF 文档", en: "PDF document", "zh-TW": "PDF 文件" },
  "chat.preview.expand": { "zh-CN": "展开预览", en: "Expand preview", "zh-TW": "展開預覽" },
  "chat.preview.download": { "zh-CN": "下载原文件", en: "Download original", "zh-TW": "下載原始檔案" },
  "chat.preview.loading": { "zh-CN": "正在加载预览…", en: "Loading preview…", "zh-TW": "正在載入預覽…" },
  "chat.preview.unavailable": { "zh-CN": "暂时无法预览，仍可下载原文件。", en: "Preview unavailable. The original file can still be downloaded.", "zh-TW": "暫時無法預覽，仍可下載原始檔案。" },
  "chat.preview.empty": { "zh-CN": "没有可预览的文本。", en: "No previewable text.", "zh-TW": "沒有可預覽的文字。" },
  "chat.preview.limited": { "zh-CN": "仅显示部分内容，下载文件可查看原文。", en: "Showing a limited preview. Download the file for the original.", "zh-TW": "僅顯示部分內容，下載檔案可查看原文。" },
  "chat.preview.slide": { "zh-CN": "幻灯片 {number}", en: "Slide {number}", "zh-TW": "投影片 {number}" },
  "chat.preview.page": { "zh-CN": "第 {number} 页", en: "Page {number}", "zh-TW": "第 {number} 頁" },
  ...
  "chat.work.summary.fileActions": {
    ...
    en: { one: "{count} file action", other: "{count} file actions" },
    "zh-TW": { other: "{count} 個檔案操作" },
  },
  "chat.work.summary.terminalActions": {
    "zh-CN": { other: "{count} 条终端操作" },
    en: { one: "{count} terminal action", other: "{count} terminal actions" },
    "zh-TW": { other: "{count} 條終端操作" },
  },
  "chat.work.summary.searchActions": {
    "zh-CN": { other: "{count} 次搜索" },
    en: { one: "{count} search", other: "{count} searches" },
    "zh-TW": { other: "{count} 次搜尋" },
  },
  "chat.work.summary.browserActions": {
    "zh-CN": { other: "{count} 个浏览器操作" },
    en: { one: "{count} browser action", other: "{count} browser actions" },
    "zh-TW": { other: "{count} 個瀏覽器操作" },
  },
  "chat.work.summary.otherActions": {
    "zh-CN": { other: "{count} 个其它工具操作" },
    en: { one: "{count} other tool action", other: "{count} other tool actions" },
    "zh-TW": { other: "{count} 個其它工具操作" },
  },
  ...
  "chat.work.detail.time": { "zh-CN": "时间", en: "Time", "zh-TW": "時間" },
  "chat.work.detail.fileContext": { "zh-CN": "文件选项", en: "File options", "zh-TW": "檔案選項" },
  "chat.work.detail.executionContext": { "zh-CN": "执行环境", en: "Execution context", "zh-TW": "執行環境" },
  "chat.work.detail.processContext": { "zh-CN": "进程操作", en: "Process action", "zh-TW": "程序操作" },
  "chat.work.detail.searchContext": { "zh-CN": "搜索对象", en: "Search target", "zh-TW": "搜尋對象" },
  "chat.work.detail.browserContext": { "zh-CN": "浏览器动作", en: "Browser action", "zh-TW": "瀏覽器動作" },
  "chat.work.detail.actionContext": { "zh-CN": "动作对象", en: "Action target", "zh-TW": "動作對象" },
  "chat.work.detail.error": { "zh-CN": "错误", en: "Error", "zh-TW": "錯誤" },
  "chat.work.detail.fileContent": { "zh-CN": "文件内容", en: "File content", "zh-TW": "檔案內容" },
  "chat.work.detail.changeResult": { "zh-CN": "变更结果", en: "Change result", "zh-TW": "變更結果" },
  "chat.work.detail.terminalOutput": { "zh-CN": "终端输出", en: "Terminal output", "zh-TW": "終端輸出" },
  "chat.work.detail.processResult": { "zh-CN": "进程结果", en: "Process result", "zh-TW": "程序結果" },
  "chat.work.detail.searchResults": { "zh-CN": "搜索结果", en: "Search results", "zh-TW": "搜尋結果" },
  "chat.work.detail.browserResult": { "zh-CN": "浏览器结果", en: "Browser result", "zh-TW": "瀏覽器結果" },
  "chat.work.detail.result": { "zh-CN": "结果", en: "Result", "zh-TW": "結果" },
  "chat.work.detail.summary": { "zh-CN": "摘要", en: "Summary", "zh-TW": "摘要" },
  ...
  "chat.work.param.target": { "zh-CN": "目标", en: "Target", "zh-TW": "目標" },
  "chat.work.param.process_id": { "zh-CN": "进程", en: "Process", "zh-TW": "程序" },
  "chat.work.param.timeout_ms": { "zh-CN": "超时", en: "Timeout", "zh-TW": "逾時" },
  "chat.work.param.background": { "zh-CN": "后台", en: "Background", "zh-TW": "背景" },
  "chat.work.param.background_kind": { "zh-CN": "后台类型", en: "Background kind", "zh-TW": "背景類型" },
  "chat.work.param.cwd": { "zh-CN": "工作目录", en: "Working directory", "zh-TW": "工作目錄" },
  "chat.work.param.offset": { "zh-CN": "偏移", en: "Offset", "zh-TW": "偏移" },
  "chat.work.param.limit": { "zh-CN": "行数", en: "Limit", "zh-TW": "行數" },
  "chat.work.param.file_path": { "zh-CN": "文件", en: "File", "zh-TW": "檔案" },
  "chat.work.param.role": { "zh-CN": "角色", en: "Role", "zh-TW": "角色" },
  ...
  "chat.activity.truncatedResultCharacters": {
    "zh-CN": { other: "因安全上限省略了 {count} 个结果字符" },
    en: { one: "{count} result character was omitted by the safety limit", other: "{count} result characters were omitted by the safety limit" },
    "zh-TW": { other: "因安全上限省略了 {count} 個結果字元" },
  },
