/* Beautiful UI atoms/Button.tsx (MIT, see ./LICENSE). */
   ...
   active:scale-[0.96] disabled:opacity-50 disabled:pointer-events-none`,
  {
    variants: {
      variant: {
        ...
        /* adapted: brand fill with its contrast-checked foreground */
        accent: `bg-accent text-on-accent hover:brightness-95 ${filledShadow}`,
