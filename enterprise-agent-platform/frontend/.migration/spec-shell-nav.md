...
- `brand()` (`:325–330`): `<div class="brand"><img class="brand__logo"
  src="/ubitech-logo.png" alt="ubitech"><span class="brand__eyebrow">agent</span></div>`.
  Used in login card AND sidebar head. (CSS hides the
...
- `knowledge`: `{title:"知识库", icon:"library", sub: \`${documents.length} 篇文档\`}`.
